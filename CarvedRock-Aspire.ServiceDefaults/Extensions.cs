...
public static class Extensions
{
    ...
    public static IHostBuilder AddCustomSerilog(this WebApplicationBuilder builder)
    {
        return builder.Host.UseSerilog((context, loggerConfig) =>
        {
            ...
            var oltpExporterEndpoint = context.Configuration["OTEL_EXPORTER_OLTP_ENDPOINT"];
            if (string.IsNullOrEmpty(oltpExporterEndpoint)) return;
            ...
            loggerConfig
                .WriteTo.OpenTelemetry(options =>
                {
                    ...
                    var headers = builder.Configuration["OTEL_EXPORTER_OLTP_HEADRERS"]?.Split(',') ?? [];
